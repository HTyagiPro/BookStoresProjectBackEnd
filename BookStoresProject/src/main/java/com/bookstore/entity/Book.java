...
public class Book {
    ...
    public Book(Long bookID, Author author, Publisher publisher, String title, String category, BigDecimal price,
            Long iSBNcode, Integer pageCount, Integer publishedYear, String bookCondition, double rating,
    ...
    // Parameterized constructor without author and publisher
    ...
    // toString method to provide a formatted string representation of the Book object
    @Override
    public String toString() {
        return "Book:\n--------------------------------\nBook ID: " + bookID + "\n\t " + author + "\n\t" + publisher
                + "\nTitle: " + title + "\nCategory: " + category + "\nPrice: " + price + "\nI.S.B.N. Code: "
                + iSBNcode + "\nPage Count: " + pageCount + "\nPublished Year: " + publishedYear 
                + "\nRecord Created On: " + rating + recordCreatedOn + "\n--------------------------------\n";
    }
}
